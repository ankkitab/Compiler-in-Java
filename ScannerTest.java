...
public class ScannerTest {
	...
	@Test
	public void testIdenti() throws LexicalException {
		String input = "//abcd\nXx";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
		//checkNext(scanner, KW_X, 0, 1, 1, 1);
		checkNext(scanner, IDENTIFIER, 7, 2, 2, 1);
	...
	@Test
	public void testEsc() throws LexicalException {
		String input = "\"ab\\t\"";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
	...
	public void test2() throws LexicalException {
		...
		checkNext(scanner, INTEGER_LITERAL, 3, 4, 1, 4);
		checkNext(scanner, OP_EXCL, 8, 1, 2, 1);
		checkNext(scanner, OP_NEQ, 9, 2, 2, 2);
	...
	@Test
	public void testMyError1() throws LexicalException {
		String input = "\" hello \n on two lines \"";
		//Scanner scanner = new Scanner(input).scan();
		show(input);
		thrown.expect(LexicalException.class);  //Tell JUnit to expect a LexicalException
	...
	@Test
	public void testMyError2() throws LexicalException {
	...
	@Test
	public void testMyError3() throws LexicalException {
		String input = "20   36";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
	...
	@Test
	public void testSerr1() throws LexicalException {
